...
class DevelopCmd(develop):
    prefix_targets = [
        ("voila/templates", 'vuetify-baseline')
    ]
    def run(self):
...
setup(
    name='voila-baseline',
    version="0.2.3",
    description="Example for usage of templates for voila-vuetify",
    data_files=data_files,
    include_package_data=True,
    author='Robert Seidl',
    author_email='robertseidl425@gmail.com',
    install_requires=['voila>=0.1.12'],
    url='https://github.com/seidlr/voila-vuetify-template-examples',
    keywords=[
        'ipython',
        'jupyter',
        'widgets',
